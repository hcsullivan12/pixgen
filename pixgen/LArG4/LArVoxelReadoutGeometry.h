...
#ifndef PixGenG4_LArVoxelReadoutGeometry_h
#define PixGenG4_LArVoxelReadoutGeometry_h
...
namespace pixgeng4 {
  ...
  public:
    ...
    struct Setup_t {
      ...
      pixgeng4::LArVoxelReadout::Setup_t readoutSetup;
  ...
  private:
    ...
    pixgeng4::LArVoxelReadout::Setup_t fReadoutSetupData;

  };

} // namespace pixgeng4

#endif // PixGenG4_LArVoxelReadoutGeometry_h
