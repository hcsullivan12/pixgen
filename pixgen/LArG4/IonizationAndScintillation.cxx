...
#include "pixgen/LArG4/ISCalculationNEST.h"
#include "pixgen/LArG4/ISCalculationSeparate.h"
...
namespace pixgeng4 {
    ...
    , fEngine(engine)
  {
    ...
    if(fISCalculator.compare("NEST") == 0)
      fISCalc = new pixgeng4::ISCalculationNEST(fEngine);
    else if(fISCalculator.compare("Separate") == 0)
      fISCalc = new pixgeng4::ISCalculationSeparate(fEngine);
    else
