/**
 * @file   pixgen/LArG4/OpBoundaryProcessSimple.hh
 * @author Ben Jones (bjpjones@mit.edu)
 * @date   March 2010
 * @see    pixgen/LArG4/OpBoundaryProcessSimple.cxx
 */
...
namespace pixgeng4 {
   ...
   * `pixgeng4::MaterialPropertiesLoader`.
   *
   ...
   *
   * This physics process is loaded in `pixgeng4::OpticalPhysics` physics
   * constructor.
   *
