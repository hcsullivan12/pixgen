...
namespace pixgeng4 {
							 ...
							 G4Transform3D DepthToWorld)
  {
	...
	volName.find("Sensitive") != std::string::npos){
      ...
      //  N.B. This name is expected by code in PixGenG4:
      std::string SDName = "AuxDetSD_AuxDet" + std::to_string(adNum) + "_" + std::to_string(svNum);
      AuxDetReadout* adReadout = new pixgeng4::AuxDetReadout(SDName, adNum, svNum);
						...
						G4Transform3D DepthToWorld)
  {
    ...
    if( volName.find("volAuxDet") != std::string::npos ){
      ...
      AuxDetReadout* adReadout = new pixgeng4::AuxDetReadout(SDName, adNum, 0);
