...
/// this information is made available to the main PixGenG4 module.
///
...
#ifndef PixGenG4_LArVoxelReadout_h
#define PixGenG4_LArVoxelReadout_h
...
namespace pixgeng4 {
   ...
   *   `pixgeng4::IonizationAndScintillation` instance
  ...
  private:
    ...
    art::ServiceHandle<sim::LArG4Parameters const>  fLgpHandle;  ///< Handle to the PixGenG4 parameters service
...
#endif // PixGenG4_LArVoxelReadout_h
