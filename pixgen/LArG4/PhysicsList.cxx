...
// PhysicsList.cxx define what the name "PixGenG4::PhysicList" means.
// However, that definition is mainly in terms of
// PixGenG4::ModularPhysicsList, a class that inherits from
...
PHYSLISTREG3(pixgeng4,PhysicsList,pixgeng4::PhysicsList)
