...
// LArSoft includes
#include "pixgen/LArG4/CustomPhysicsFactory.hh"
...
// http://cdcvs.fnal.gov/redmine/projects/larsoft/wiki/PixGenG4 for more details.
pixgeng4::CustomPhysicsFactory<NeutronHPphysics> dummy_factory("NeutronHP");
