////////////////////////////////////////////////////////////////////////
//
//  \file DetectorPropertiesPixGen.cxx
//
...
#include "pixgen/Services/DetectorPropertiesPixGen.h"
...
namespace ldp{
  ...
  //--------------------------------------------------------------------
  DetectorPropertiesPixGen::DetectorPropertiesPixGen() :
  ...
  //--------------------------------------------------------------------
  DetectorPropertiesPixGen::DetectorPropertiesPixGen(fhicl::ParameterSet const& pset,
  ...
  //--------------------------------------------------------------------
  bool DetectorPropertiesPixGen::Update(uint64_t t) 
  {
  ...
  //--------------------------------------------------------------------
  bool DetectorPropertiesPixGen::UpdateElectronLifetime(uint64_t t) 
  {

    std::string tableName = "elifetime";
    nutools::dbi::Table tbl;
    
    tbl.SetDetector("PixGen");
  ...
  //--------------------------------------------------------------------
  bool DetectorPropertiesPixGen::UpdateClocks(const detinfo::DetectorClocks* clks) 
  {
    fClocks = clks;
  ...
  //------------------------------------------------------------
  double DetectorPropertiesPixGen::ConvertTDCToTicks(double tdc) const
  {
    return fClocks->TPCTDC2Tick(tdc);
  }
  
  //--------------------------------------------------------------
  double DetectorPropertiesPixGen::ConvertTicksToTDC(double ticks) const
  {
    return fClocks->TPCTick2TDC(ticks);
  }
  
  //--------------------------------------------------------------------
  void DetectorPropertiesPixGen::Configure(Configuration_t const& config) {
  ...
  } // DetectorPropertiesPixGen::Configure()
  
  //--------------------------------------------------------------------
  DetectorPropertiesPixGen::Configuration_t
  DetectorPropertiesPixGen::ValidateConfiguration(
  ...
  //--------------------------------------------------------------------
  void DetectorPropertiesPixGen::ValidateAndConfigure(
    fhicl::ParameterSet const& p, std::set<std::string> ignore_params /* = {} */
  ) {
  ...
  //------------------------------------------------------------------------------------//
  void DetectorPropertiesPixGen::Setup(providers_type providers) {
  ...
  } // DetectorPropertiesPixGen::Setup()
  
  
  //------------------------------------------------------------------------------------//
  double DetectorPropertiesPixGen::Efield(unsigned int planegap) const
  {
    if(planegap >= fEfield.size())
      throw cet::exception("DetectorPropertiesPixGen") << "requesting Electric field in a plane gap that is not defined\n";
    
    return fEfield[planegap];
  }
    
  //------------------------------------------------
  double DetectorPropertiesPixGen::Density(double temperature) const
  {
    ...
    return density;
  } // DetectorPropertiesPixGen::Density()
  ...
  //
  double DetectorPropertiesPixGen::Eloss(double mom, double mass, double tcut) const
  {
    // Some constants.
    ...
    return dedx;
  } // DetectorPropertiesPixGen::Eloss()
  
  //----------------------------------------------------------------------------------
  double DetectorPropertiesPixGen::ElossVar(double mom, double mass) const
  {
    // Some constants.
    ...
    return result;
  } // DetectorPropertiesPixGen::ElossVar()


  //------------------------------------------------------------------------------------//
  double DetectorPropertiesPixGen::DriftVelocity(double efield, double temperature) const 
  {
  ...
  //
  if(efield > 4.0)
    mf::LogWarning("DetectorPropertiesPixGen") << "DriftVelocity Warning! : E-field value of "
				    << efield
  ...
  if(temperature < 87.0 || temperature > 94.0)
    mf::LogWarning("DetectorPropertiesPixGen") << "DriftVelocity Warning! : Temperature value of "
				    << temperature
...
//     icarus fit at most fields to Walkowiak at very high fields
  ...
  double DetectorPropertiesPixGen::BirksCorrection(double dQdx) const
  {
  ...
  double DetectorPropertiesPixGen::ModBoxCorrection(double dQdx) const
  {
  ...
  //------------------------------------------------------------------------------------//
  int  DetectorPropertiesPixGen::TriggerOffset()     const 
  {
  ...
  double DetectorPropertiesPixGen::ConvertXToTicks(double X, int p, int t, int c) const
  {
  ...
  double  DetectorPropertiesPixGen::ConvertTicksToX(double ticks, int p, int t, int c) const
  {
  ...
  //--------------------------------------------------------------------
  void DetectorPropertiesPixGen::CheckIfConfigured() const
  {
    if (!fGeo) throw cet::exception(__FUNCTION__) << "Geometry is uninitialized!";
    if (!fLP) throw cet::exception(__FUNCTION__) << "LArPropertiesPixGen is uninitialized!";
    if (!fClocks) throw cet::exception(__FUNCTION__) << "DetectorClocks is uninitialized!";
  }

  //--------------------------------------------------------------------
  void DetectorPropertiesPixGen::CalculateXTicksParams()
  {
    CheckIfConfigured();
  ...
  //--------------------------------------------------------------------
  double DetectorPropertiesPixGen::GetXTicksOffset(int p, int t, int c) const
  {
    return fXTicksOffsets.at(c).at(t).at(p);
  }

  //--------------------------------------------------------------------
  double DetectorPropertiesPixGen::GetXTicksCoefficient() const
  {
    return fXTicksCoefficient;
  }

  //--------------------------------------------------------------------
  double DetectorPropertiesPixGen::GetXTicksCoefficient(int t, int c) const
  {
