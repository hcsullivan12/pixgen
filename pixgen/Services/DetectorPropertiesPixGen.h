////////////////////////////////////////////////////////////////////////
// \file DetectorPropertiesPixGen.h
//
...
namespace ldp{
  ...
  class DetectorPropertiesPixGen : public detinfo::DetectorProperties {
    public:
      ...
      struct Configuration_t {
        ...
        fhicl::Atom<bool        > GetElectronlifetimeFromDB {
          ...
          Comment("option to get electron lifetime from PixGen conditions database")
        };
      ...
      DetectorPropertiesPixGen();
      DetectorPropertiesPixGen(fhicl::ParameterSet const& pset, 
       ...
       * @param providers pack of providers DetectorPropertiesPixGen depends on
       * @see Setup()
       */
      DetectorPropertiesPixGen(fhicl::ParameterSet const& pset,
                         providers_type providers,
                         std::set<std::string> ignore_params = {});
      DetectorPropertiesPixGen(DetectorPropertiesPixGen const&) = delete;
      virtual ~DetectorPropertiesPixGen() = default;
       ...
       * Example:
       *     
       *     lar::DetectorPropertiesPixGen::providers_type providers;
      ...
      /// @throw cet::exception (category DetectorPropertiesPixGen) if not ok
    ...
    }; // class DetectorPropertiesPixGen
} //namespace detinfo
