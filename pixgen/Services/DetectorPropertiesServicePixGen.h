////////////////////////////////////////////////////////////////////////
// DetectorPropertiesServicePixGen.h
//
...
namespace ldp{
  ...
  /**
   * @brief "PixGen" implementation of DetectorProperties service
   * 
   * This class wraps DetectorPropertiesPixGen provider into a art service.
   * It delivers the provider via the standard interface:
   *     
   *     detinfo::DetectorProperties const* detprop
   *       = art::ServiceHandle<detinfo::DetectorPropertiesPixGen>()
   *       ->provider();
   *     
   * or, using the standard interface in "CoreUtils/ServiceUtil.h":
   *     
   *     auto const* detprop
   *       = lar::providerFrom<detinfo::DetectorPropertiesPixGen>();
   *     
  ...
  class DetectorPropertiesServicePixGen : public detinfo::DetectorPropertiesService {
    ...
    public:
      ...
      struct ServiceConfiguration_t {
        ...
        ldp::DetectorPropertiesPixGen::Configuration_t ProviderConfiguration;
      ...
      DetectorPropertiesServicePixGen(fhicl::ParameterSet const& pset,
    ...
    private:
      ...
      std::unique_ptr<ldp::DetectorPropertiesPixGen> fProp;
      ...
      bool isDetectorPropertiesServicePixGen(const fhicl::ParameterSet& ps) const;
...
DECLARE_ART_SERVICE_INTERFACE_IMPL(ldp::DetectorPropertiesServicePixGen, detinfo::DetectorPropertiesService, LEGACY)
