...
#include "pixgen/Services/PixGenSignalShapingService.h"
...
//----------------------------------------------------------------------
// Constructor.
util::PixGenSignalShapingService::PixGenSignalShapingService(const fhicl::ParameterSet& pset,
...
//----------------------------------------------------------------------
// Destructor.
util::PixGenSignalShapingService::~PixGenSignalShapingService()
{
}
...
//----------------------------------------------------------------------
// Reconfigure method.
void util::PixGenSignalShapingService::reconfigure(const fhicl::ParameterSet& pset)
{
...
util::PixGenSignalShapingService::SignalShaping() const
{
  if(!fInit) init();
...
//----------------------------------------------------------------------
void util::PixGenSignalShapingService::init()
{
  if (fInit) return;
  fInit = true;
...
//----------------------------------------------------------------------
double util::PixGenSignalShapingService::ElectronsToCurrent(double const& el) const
{
...
//----------------------------------------------------------------------
void util::PixGenSignalShapingService::SetElectResponse()
{
...
namespace util {
  ...
  DEFINE_ART_SERVICE(PixGenSignalShapingService)
