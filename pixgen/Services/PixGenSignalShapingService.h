///////////////////////////////////////////////////////////////////////
///
/// \file   PixGenSignalShapingService.h
///
...
namespace util {
  class PixGenSignalShapingService {
  public:

    // Constructor, destructor.

    PixGenSignalShapingService(const fhicl::ParameterSet& pset,
				   art::ActivityRegistry& reg);
    ~PixGenSignalShapingService();
  ...
  private:
    ...
    void init() const{const_cast<PixGenSignalShapingService*>(this)->init();}
    void init();
...
//----------------------------------------------------------------------
// Do convolution.
template <class T> inline void util::PixGenSignalShapingService::Convolute(std::vector<T>& func) const
{ 
  SignalShaping().Convolute(func);
}


DECLARE_ART_SERVICE(util::PixGenSignalShapingService, LEGACY)
#endif
